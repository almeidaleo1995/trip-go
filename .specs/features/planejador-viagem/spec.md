...
| Dados de demonstração | A viagem real do usuário, extraída dos PDFs: Europa 2027, 30/12/2026 a 15/01/2027, 17 dias, 7 países, cruzeiro MSC Preziosa pelo Mar do Norte e Canal da Mancha | Pedido do usuário. Deixa de ser demo e passa a ser a viagem de verdade: os PDFs viram JSON de importação | y |
