...
T = [
 ...
 ("Viagem de demonstracao",
  "JSON da viagem real do usuario - Europa 2027, cruzeiro MSC Preziosa - extraido dos dois PDFs pela skill de conversao.",
  ...
  "none", "none", "feat(db): viagem europa 2027 extraida dos pdfs"),
